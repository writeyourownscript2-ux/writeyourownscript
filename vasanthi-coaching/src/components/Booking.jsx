    ...
    <section id="book" className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-pink-100/80 text-lg mb-12 max-w-2xl mx-auto leading-relaxed">
            Your first step toward transformation starts with a conversation. No pressure, no commitment —
            just an honest talk about where you are and where you want to be.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {[
              ...
              >
                ...
                <div className="text-pink-200/70 text-sm">{item.desc}</div>
              </div>
            ))}
          </div>
